---
title: Discord
description: A guide on setting up the Discord module.
---
...
<figure>
  <img src="/bot/intent.png" alt="Enabling the Server Members Intent" />
  <figcaption>Enabling the <code>Server Members Intent</code> intent on the Discord Bot.</figcaption>
</figure>
...
<figure><img src="/bot/oauth2.png" alt="" /><figcaption><p>Checking the 'bot' scope in the OAuth2 URL Generator.</p></figcaption></figure>
...
<figure><img src="/bot/perms.png" alt="" /><figcaption><p>Selecting the necessary <code>Bot Permissions</code> for the Discord Bot to function.</p></figcaption></figure>
...
<figure><img src="/bot/devMode.png" alt="" /><figcaption><p>Turning on Developer Mode in App Settings in Discord.</p></figcaption></figure>
...
<figure><img src="/bot/copyID.png" alt="" /><figcaption><p>Copying the channel ID.</p></figcaption></figure>
